 ...
 * of a date object cannot be changed after initializing an instance
 * of Date.
...
public class Date implements Comparable<Date> {
    ...
    /**
     * Creates a Date object using a LocalDate.
     * @param date LocalDate representing the date entered.
     */
    ...
    /**
     * Creates a Date object using a Calendar input.
     * @param date Calendar object representing a calendar date.
     */
